...
class store_test extends \cachestore_tests {
     ...
     * @return array
     */
    public function provider_for_getset_serialization_test(): array {
        $data = [
            [
                'PHP serializer',
     ...
     *
     * @dataProvider provider_for_getset_serialization_test
     * @param string $name
     * @param int $serializer
     */
    public function test_getset_serialization(string $name, int $serializer): void {
